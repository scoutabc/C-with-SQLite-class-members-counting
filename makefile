objects = main.o create.o create.h sqlite3.c help.o count.o change.o change_class.o change_student.o change_service.o list.o
...
list.o : create.h sqlite3.c list.c
	gcc -c list.c
